      ...
      <div style={{ maxWidth: 1400, margin: '0 auto', padding: '52px 24px 28px' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 16 }}>
              ...
              <span style={{ fontWeight: 900, color: '#fff', fontSize: 20 }}>
                Urban<span style={{ color: '#22c55e' }}>Serve</span>
              </span>
            </div>
            <p style={{ color: '#64748b', fontSize: 14, lineHeight: 1.7 }}>
              India's simplest platform to find work and hire verified workers.
            </p>
          </div>
          ...
          <div>
            ...
            {[['Find Jobs', '/gigs'], ['Register as Worker', '/onboarding'], ['Pick & Drop', '/pick-drop'], ['My Dashboard', '/dashboard']].map(([l, h]) => (
              <Link key={h} href={h} style={{ display: 'block', color: '#64748b', fontSize: 14, textDecoration: 'none', marginBottom: 10 }}
          ...
          <div>
            ...
            <p style={{ color: '#64748b', fontSize: 14, lineHeight: 1.7 }}>
              📧 support@urbanserve.in<br />
              📞 1800-XXX-XXXX<br />
              🕐 Mon–Sat, 9am–6pm
            </p>
          </div>

          {/* 🔥 QR Scanner Section (NEW) */}
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontWeight: 700, color: '#94a3b8', fontSize: 12, letterSpacing: '0.08em', marginBottom: 16 }}>
              SCAN TO VISIT
            </div>

            <img
              src="/qr.png"   // 👈 your file in /public
              alt="UrbanServe QR"
              style={{
                width: '120px',
                height: '120px',
        ...
        <div style={{
          ...
          <p style={{ color: '#475569', fontSize: 13 }}>
            © 2026 UrbanServe. Made in India 🇮🇳
          </p>

          <div style={{ display: 'flex', gap: 16 }}>
            {['Privacy', 'Terms', 'Support'].map(l => (
              <span key={l} style={{ color: '#475569', fontSize: 13, cursor: 'pointer' }}>
                {l}
              </span>
            ))}
          </div>
