      ...
      <div style={{ background:'#fff', borderRadius:28, padding:'48px 36px', width:'100%', maxWidth:400, textAlign:'center', boxShadow:'0 20px 60px rgba(22,163,74,0.12)', border:'1.5px solid #e6f4ea' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <button onClick={loginWithGithub}
            style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:12, padding:'16px 20px', background:'linear-gradient(135deg,#16a34a,#22c55e)', border:'none', borderRadius:16, fontSize:16, fontWeight:700, cursor:'pointer', color:'#fff', fontFamily:'inherit', boxShadow:'0 4px 20px rgba(22,163,74,0.3)' }}>
